          ...
          <ul className="mt-4 space-y-2">
            <li>
              <a
                ...
                className="flex p-2 text-gray-700 hover:bg-gray-200 rounded"
              >
            ...
            <li>
              <Link
                ...
                className="p-2 flex text-gray-700 hover:bg-gray-200 rounded"
              >
            ...
            <li onClick={() => setIsOpen(false)}>
              <a
                ...
                className="flex p-2 text-gray-700 hover:bg-gray-200 rounded"
              >
                <IoMdCloseCircle size={20} color="red" className="mr-3" /> close
                menu
              </a>
            </li>
          </ul>
